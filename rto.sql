...
INSERT INTO `registered_person` (`ID`, `Name`, `DOB`, `Address`, `Pincode`, `Email`, `Mobile`) VALUES
...
--
ALTER TABLE `apply_for_learning`
  ADD CONSTRAINT `apply_for_learning_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `apply_for_registration`
--
ALTER TABLE `apply_for_registration`
  ADD CONSTRAINT `apply_for_registration_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `lli`
--
ALTER TABLE `lli`
  ADD CONSTRAINT `lli_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `own`
--
ALTER TABLE `own`
  ADD CONSTRAINT `own_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `pli`
--
ALTER TABLE `pli`
  ADD CONSTRAINT `pli_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `renewal`
--
ALTER TABLE `renewal`
  ADD CONSTRAINT `renewal_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `registered_person` (`ID`);

--
-- Constraints for table `transfer_of_ownership`
--
ALTER TABLE `transfer_of_ownership`
  ADD CONSTRAINT `transfer_of_ownership_ibfk_1` FOREIGN KEY (`Buyer_ID`) REFERENCES `registered_person` (`ID`),
  ADD CONSTRAINT `transfer_of_ownership_ibfk_2` FOREIGN KEY (`Seller_ID`) REFERENCES `registered_person` (`ID`);
COMMIT;
